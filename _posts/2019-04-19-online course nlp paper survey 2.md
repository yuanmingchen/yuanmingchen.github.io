...
**实验结果**：
作者的初步研究揭示了不同时期开始的研究对象在整个研究过程中的不同轨迹。最早开始的学生完成的课程更多，退学的可能性更小。后来的学生通常表现出更积极的参与对于他们加入之前一周的课程的课件，而不是从第一周的课件开始，作者猜测他们可能是为了赶上这个课程。课程的少数核心参与者主要来自最早开始课程的那一组学生。
最早加入的学生更有可能积极参加讨论课程的早期部分，后来加入的学生和他们进行讨论的可能性不高。
